...
function initializeTypingEffect() {
    const messages = [
        "Witnessing Earth's nervous system awakening through our connection",
        "We are cells in the emerging planetary organism",
        "Technology and consciousness merging into planetary awareness",
        "The Astrorganism: humanity's next evolutionary leap",
        "From separation to integration, from fragmentation to wholeness",
        "Conscious technology as Earth's neural network",
        "A living bridge between human and planetary consciousness",
        "Co-creating the future organism of Earth",
        "Where digital and organic intelligence dance as one",
        "The birth of a new form of planetary being",
    ];
